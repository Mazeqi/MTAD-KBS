...
class cfg(cfg_common, cfg_dataset_default, cfg_model_tmad):

	def __init__(self):
		# super(cfg, self).__init__()
		cfg_common.__init__(self)
		cfg_dataset_default.__init__(self)
		cfg_model_tmad.__init__(self)
		...
		self.batch_train = 8  # official 16
		...
		self.data.root = '/home/tanpengjie1/Mazeqi/dataset/mvtec'
		...
		self.model.name = 'tmad'
		# checkpoint_path = "runs/TMADTrainer_configs_tmad_tmad_256_100e_20240912-221527/net_40.pth"
		checkpoint_path = "runs/TMADTrainer_configs_tmad_tmad_256_100e_20240913-220656_hilbertN8/net_300.pth"
		self.model.kwargs = dict(pretrained=False, checkpoint_path=checkpoint_path, strict=False, model_t=self.model_t,
		...
		#self.optim.kwargs = dict(name='adamw', betas=(0.9, 0.999), eps=1e-8, weight_decay=self.weight_decay, amsgrad=True)
		self.optim.kwargs = dict(name='adamw')

		# ==> trainer
		self.trainer.name = 'TMADTrainer'
