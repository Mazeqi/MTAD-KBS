...
class cfg(cfg_common, cfg_dataset_default, cfg_model_mambaad):
	...
	def __init__(self):
		...
		checkpoint_path = "runs/mambaad_offical_weights/mambaad_mvtec_net_450.pth"
		self.model.kwargs = dict(pretrained=True, checkpoint_path=checkpoint_path, strict=True, model_t=self.model_t,
