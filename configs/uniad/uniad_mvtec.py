...
class cfg(cfg_common, cfg_dataset_default, cfg_model_uniad):
	...
	def __init__(self):
		...
		checkpoint_path = '/home/tanpengjie1/Mazeqi/tmb/TMAD_ADer/runs/single_cls/uniad_mvtec/mean_state_dict.pth'
		self.model.kwargs = dict(pretrained=False, checkpoint_path=checkpoint_path, strict=True, model_backbone=self.model_backbone,
